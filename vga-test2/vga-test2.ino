...
l++;
    ...
    if (TCNT2 > 0x0f){
      ...
      if ((linecount == 1)||(linecount == 2)){
       ...
       {
        if((linecount == 250) ||(linecount == 251) )
       //if(linecount%4!=0)
        {
            WHITE;
            delayMicroseconds(3);NOP;NOP;NOP;NOP;NOP;NOP;NOP;
            WHITE;
            delayMicroseconds(3);NOP;NOP;NOP;NOP;NOP;NOP;NOP;
            WHITE;
            delayMicroseconds(3);NOP;NOP;NOP;NOP;NOP;NOP;NOP;
...
//                           NOP;NOP;NOP;NOP;NOP;//;NOP;NOP;NOP;
            ...
            BLACK;
            delayMicroseconds(6);NOP;NOP;NOP;NOP;NOP;NOP;NOP;NOP;
            BLACK;
            NOP;NOP;
//                BLACK;
//                delayMicroseconds(3);NOP;NOP;NOP;NOP;NOP;NOP;NOP;NOP;
